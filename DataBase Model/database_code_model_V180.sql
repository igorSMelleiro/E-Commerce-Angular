...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`product` (
  ...
  `store_product_prod_id` INT(11) NOT NULL,
  `user_usr_id` INT(11) NOT NULL,
  PRIMARY KEY (`prod_id`, `store_store_id`, `store_product_prod_id`, `user_usr_id`),
  UNIQUE INDEX `prod_code_UNIQUE` (`prod_code` ASC) INVISIBLE,
  INDEX `fk_product_user1_idx` (`user_usr_id` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`user` (
  ...
  UNIQUE INDEX `usr_password` (`usr_password` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`address` (
  ...
  `store_store_id` INT(11) NOT NULL,
  `store_product_prod_id` INT(11) NOT NULL,
  PRIMARY KEY (`address_id`, `store_store_id`, `store_product_prod_id`),
  INDEX `fk_address_store1_idx` (`store_store_id` ASC, `store_product_prod_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`city_has_address` (
  ...
  INDEX `fk_city_has_address_address1_idx` (`address_address_id` ASC) VISIBLE,
  INDEX `fk_city_has_address_city1_idx` (`city_city_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`product_has_address` (
  ...
  INDEX `fk_product_has_address_address1_idx` (`address_address_id` ASC) VISIBLE,
  INDEX `fk_product_has_address_product1_idx` (`product_prod_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ambardb_model`.`orders` (
  ...
  CONSTRAINT `fk_orders_product1`
    FOREIGN KEY (`product_prod_id` , `product_store_store_id`)
    REFERENCES `ambardb_model`.`product` (`prod_id` , `store_store_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
